...
//        [slider addSubview:busIcon_];
        ...
        routeNumber_ = [[AutoScrollLabel alloc] initWithFrame:CGRectMake( busIcon_.bounds.origin.x + BUS_ICON_WIDTH + 8, 0, ROUTE_NUM_WIDTH, ROUTE_NUM_HEIGHT)];//[[MarqueeLabel alloc] initWithFrame:CGRectMake( busIcon_.bounds.origin.x + BUS_ICON_WIDTH + 8, 4, ROUTE_NUM_WIDTH, ROUTE_NUM_HEIGHT) andSpeed:3 andBuffer:3.0f];
        ...
        routeNumber_.scrollSpeed = 20.0f;
        routeNumber_.pauseInterval = 0.9f;
        routeNumber_.bufferSpaceBetweenLabels = 36;
        
        routeNumber_.text = @"12";
        //routeNumber_.textAlignment = UITextAlignmentLeft;
        [routeNumber_ setTextAlightment:UITextAlignmentLeft];
        routeNumber_.textColor = [UIColor blackColor];
